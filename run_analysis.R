...
## Deepthi Dulluri - dt 7 May 2016
## function to tidy data 

# remove elements in directory first to start clean slate###
rm(list=ls())
####################
#check if data.table is already present in R installation, else install ##the package
